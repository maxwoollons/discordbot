...
var botConfigs = {
    token: "NTc5MjExOTAxMjE3NTM4MTA3.XN-8YQ.bUBAOFp1CLmLP64144XbPzSuNtc",
    prefix: "!",
    gameStatus: "Aiden's Language",
    statusType: "Watching",
    commands: [
    {
        "id": 1,
        "command": "WhoAreYou",
        "message": "My main purpose is to take out un cristian thots",
        "embed": false
    },
    {
        "id": 2,
        "command": "bannedwords",
        "message": "none of your bussiness",
        "embed": false
    },
    {
        "id": 3,
        "command": "god",
        "message": "The_Invaders1 is the one and only god",
        "embed": false
    }
],
    plugins: [
    ...
    autorole: {
    "guildID": "462717814810345472",
    "autoroleID": "462719892626341888"
},
    ticketsystem: {
    "ticketCategoryID": "",
